                    ...
                    <td align="center" valign="top" style="background: #FFFFFF;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 620px;">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <span>Новая заявка на кредит</span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td width="600">
                        <a href="{{ $content['link'] }}" target="_blank">
                            <img src="{{ $content['picture'] }}" width="600" alt="" style="display: block; border-radius: 2%">
                        </a>
                    </td>
                </tr>
                </tbody>
                ...
                <tr>
                    <td width="600">
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="" style="vertical-align:top;width:612px;"><![endif]-->
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                ...
                                <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:700;line-height:1;text-align:left;color:#3E848C;">
                                            <p>Марка Модель автомобиля:</p></div>
                                    </td>
                                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:700;line-height:1;text-align:left;color:#3e468c;">
